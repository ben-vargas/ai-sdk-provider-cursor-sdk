...
(`LanguageModelV3` / `ProviderV3`) with the public surface of `@cursor/sdk@1.0.28`, the version
pinned on `main`. It describes the AI SDK v7 behavior implemented on `main`; rows that differ for the
...
`@cursor/sdk@1.0.28` still does not export those functions from its public package entry point. The
